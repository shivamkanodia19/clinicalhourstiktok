...
def critique_slide_image(
    ...
    prompt_text = ascii_safe(
        f'You are a visual critic reviewing a TikTok slideshow image.\n\n'
        f'SLIDE ROLE: {role}\n'
        f'SLIDE TYPE / GOAL: {goal_type}\n'
        f'COPY TEXT on slide (headline): "{text}"\n'
        f'SUBTEXT: "{subtext}"\n\n'
        + prev_ctx
        + 'Evaluate this image on exactly 6 criteria and be specific:\n'
        '1. WORD COUNT: Is the headline text visible on the image? Does it exceed 6 words?\n'
        '2. TEXT HIERARCHY: Is there visual clutter? Is the headline clearly dominant?\n'
        '3. SCREENSHOT: For this slide role, should a product screenshot appear? '
        'If yes, is the placement correct and prominent enough?\n'
        '4. MARKETING FIT: Does the visual composition serve the slide\'s narrative role '
        'and emotional goal?\n'
        '5. VISUAL SIMILARITY: Does this image look too similar to any of the previously '
        'completed slides listed above? Same object, same composition, same color zone?\n'
        '6. GOAL ACHIEVEMENT: Does every visual decision (gradient, object, layout, scale) '
        'actively serve this slide\'s specific purpose in the carousel?\n\n'
        'Return valid JSON ONLY. No markdown. No explanation outside the JSON.\n'
        '{\n'
        '  "issues": ["specific issue 1", "specific issue 2"],\n'
        '  "similarity_flags": ["Slide N looks similar because ..."],\n'
        '  "marketing_verdict": "one sentence on overall marketing fit",\n'
        '  "refined_prompt": "complete improved image generation prompt that fixes all issues above"\n'
        '}\n'
        'If no issues found: return empty arrays and a refined_prompt that reinforces '
        'what is working well. The refined_prompt must always be a complete, standalone '
        'image generation prompt (not a diff or a note).'
    )
